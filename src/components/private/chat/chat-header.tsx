...
export function ChatHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-12 border-b border-red-500/20 bg-black/80 backdrop-blur-md">
      <div className="h-full flex items-center justify-between max-w-4xl mx-auto w-full px-4">
        <div className="font-mono text-sm text-red-500 font-bold">MonkLog</div>
